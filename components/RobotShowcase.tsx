...
export function RobotShowcase() {
  return (
    <section className="relative overflow-hidden px-6 py-16 sm:px-8 sm:py-20">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.14),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(129,140,248,0.12),transparent_24%),linear-gradient(180deg,#060a12,#0a1020_56%,#090d18)]" />
